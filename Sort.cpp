...
// test
    ...
    else if(s==3)
    {
        ...
        else if (v==2) // Savo nuoÅ¾iÅ«ra Ävedame skaiÄ?ius. NorÄ—dami baigti ÄvedimÄ…, Ävedame bet kokÄ simbolÄ - ne skaiÄ?iÅ³.
        { N = 0; while (cin >> a[N]) N++; }
    }
    else
    {
...
//-------------------------------------------------------  
//Spartuji ruðiavimo algoritma (angla quick sort).
//-------------------------------------------------------
...
//-------------------------------------------------------
//Suliejimo(salajos) ruðiavimo algoritma (angl. merge sort).
//-------------------------------------------------------
template <class T>
